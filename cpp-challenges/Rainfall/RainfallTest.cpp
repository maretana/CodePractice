...
#define TEST_SUITE RainfallTests
...
{
    bool inrange = std::abs(act - exp) <= 1e-2;
    EXPECT_TRUE(inrange) << "Testing at 1e-2; Expected should be " << exp << ", but got " << act << std::endl;
}

TEST(TEST_SUITE, MeanData) {
